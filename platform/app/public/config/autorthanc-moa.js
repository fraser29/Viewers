...
window.config = {
  ...
  // Backend used by the kispi-uro mode ("Load automated segmentation", optional report POST).
  // In development, proxy /api to your segmentation service, e.g.
  //   PROXY_TARGET=/api PROXY_DOMAIN=http://localhost:5055
  kispiUro: {
    apiBaseUrl: '/api',
  },
